...
echo ""
echo "Upgrading existing DB: run the migration script once on the server:"
echo "  psql -U <user> -d <database> -f database/migrate_004_rename_roles.sql"
echo "Note: The PHP app also runs this migration automatically on the first request."
