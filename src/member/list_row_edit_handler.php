...
// CELL-01 + D-15: member can only edit their own row
// can_edit_cell() for members checks: visibility='public' AND $_SESSION['user_id'] === $member_id
...
if ((int)$_SESSION['user_id'] !== $member_id) {
    http_response_code(403);
    echo '<h1>Nicht berechtigt</h1>';
    exit;
}
...
// Fetch existing cell values for this member
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!can_edit_cell($list_id, $member_id) || (int)$_SESSION['user_id'] !== $member_id) {
