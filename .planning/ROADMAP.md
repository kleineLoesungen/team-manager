...
| 9. UI-Vereinheitlichung | 0/8 | Planned | |
...
Plans:
- [ ] 09-01-PLAN.md — Infrastructure: CSS migration, render_page(), 12 partials, thin wrappers
- [ ] 09-02-PLAN.md — Tracer: coordinator/lists.php migration + human verify
...
- [x] 08-02-PLAN.md — Multi-team auth flow: coordinator_teams login query, team picker, require_coordinator guard
